...
6. **Console** — Check for JS errors, failed requests, and warnings (`playwright-cli console`).
7. **Responsiveness** — If relevant, test at different viewport sizes (`playwright-cli resize 768 1024` etc.).
